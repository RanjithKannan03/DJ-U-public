...
const SearchBarMobile = ({ searchTerm, setSearchTerm }) => {
    return (
        <div className='flex items-center flex-1 md:flex-none md:w-1/2 xl:w-1/3 bg-[#303030] px-2 py-1 lg:py-2 lg:px-3 gap-3 rounded-full font-montserrat'>
