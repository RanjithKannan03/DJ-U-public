...
const RegisterForm = () => {
    ...
    return (
        <div className='flex w-full lg:w-[40%] xl:w-[30%] flex-col gap-4 p-4 text-white font-montserrat'>
            ...
            <span className="text-3xl font-semibold text-center md:text-4xl lg:text-5xl">Welcome</span>
            ...
            <span className=''>Already have an account?
                <span className='bg-gradient-to-r from-[#AA15A2] to-[#a60de7] bg-clip-text'>
                    <Link className='text-transparent ' href={'/login'}>Sign in</Link>
                </span>
            </span>
            ...
            <form className='flex flex-col gap-4' action={formAction}>
                ...
                <div className="relative items-center w-full px-2 py-1 border border-gray-200 rounded-md 0 focus-within:ring-1 focus-within:ring-black">
                    <input
                        ...
                        name="email"
                        className="peer w-full appearance-none bg-transparent px-2.5 pb-2.5 pt-4 text-sm text-white focus:outline-0 dark:text-white"
                        placeholder=" "
                    />
                    <label
                        htmlFor="floating_outlined_email"
                        className="absolute start-1 top-2 z-10 origin-[0] -translate-y-4 scale-75 transform bg-black  px-2 text-sm text-gray-500 duration-300 peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:scale-100 peer-focus:top-2 peer-focus:-translate-y-4 peer-focus:scale-75 peer-focus:px-2 peer-focus:text-white rtl:peer-focus:left-auto rtl:peer-focus:translate-x-1/4  dark:text-gray-400  peer-focus:bg-black"
                    >
                        Email
                    </label>
                </div>
                ...
                <div className="relative flex items-center w-full px-2 py-1 border border-gray-200 rounded-md 0 focus-within:ring-1 focus-within:ring-black">
                    <input
                        ...
                        className="peer flex-1 appearance-none bg-transparent px-2.5 pb-2.5 pt-4 text-sm text-white focus:outline-0 dark:text-white"
                        placeholder=" "
                    />
                    <button
                        type="button"
